        ...
        <div style={{ display: 'grid', gridTemplateColumns: '7fr 5fr', gap: '64px', alignItems: 'start' }} className="book-grid">
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '28px' }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--violet)', marginBottom: '10px' }}>If you are hiring</div>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <p style={{ fontFamily: 'var(--font-inter)', fontSize: '14px', color: 'var(--text-low)' }}>BU Questrom MSBA &apos;26 &nbsp;&bull;&nbsp; British Airways, Starbucks, Newdia Fenway &nbsp;&bull;&nbsp; US authorized to work 4+ years</p>
          </div>
