            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  borderRadius: '50%',
                  background: 'conic-gradient(from 0deg, #ff6b6b, #ffd93d, #6bcb77, #4d96ff, #a855f7, #ec4899, #ff6b6b)',
                  animation: reduced ? 'none' : 'ringRotate 40s linear infinite',
                }}
                aria-hidden="true"
              />
              {/* Gap ring */}
              ...
              >
                <Image
                  ...
                  alt="Divyesh Annavarapu with classmates"
                  fill
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', width: '100%', maxWidth: '380px' }}>
              {STAT_TILES.map(tile => (
                ...
                >
                  ...
                  <div style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '10px', color: 'var(--text-low)', letterSpacing: '0.08em', marginTop: '6px', textTransform: 'uppercase' }}>
                    {tile.bottom}
                  </div>
                </div>
              ))}
